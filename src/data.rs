...
# package-applications-visualelements-displayname = "My Rust UWP application"

## (String, required) The description of the app.

# package-applications-visualelements-description = "A UWP application written in Rust"
